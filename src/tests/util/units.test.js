...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of achi", () => {
      const result = units.getUnit("achi");

      expect(result).toBe(1);
    });
    it("gets unit of sten", () => {
      const result = units.getUnit("sten");
    ...
    it("gets unit of achi using alias", () => {
      const result = units.getUnit("ch");

      expect(result).toBe(1);
    });
    it("gets unit of sten using alias", () => {
  ...
  describe("#getDisplay", () => {
    ...
    it("gets display of sten", () => {
      const result = units.getDisplay("sten");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("achi", 9);

      const result = units.getUnit("achi");

      expect(result).toEqual(9);

      units.setUnit("achi", 1);
    });
  });
  describe("#setDisplay", () => {
