...
import { Card, CopyToClipboard, Flex, Table } from '@achi/core';
import type { RootState } from '../../modules/rootReducer';
import type { Row } from '../core/components/Table/Table';
import { sten_to_achi_string, sten_to_colouredcoin_string } from '../../util/achi';
...
const getCols = (type: WalletType) => [
  ...
  },
  {
    field: (row: Row) => type === WalletType.COLOURED_COIN
      ? sten_to_colouredcoin_string(row.amount)
      : sten_to_achi_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => sten_to_achi_string(row.fee_amount),
