...
import icon from '../../assets/img/achi_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <BugReport href="https://github.com/Achi-Coin/achi-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
