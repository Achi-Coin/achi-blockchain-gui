...
import { CardHero, Link } from '@achi/core';
import { PlotHero as PlotHeroIcon } from '@achi/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Achi. '}
              <Link target="_blank" href="https://achicoin.org/achipedia/">Learn more</Link>
            </Trans>
          </Typography>
          <Button
