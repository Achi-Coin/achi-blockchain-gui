...
export default function CreateOffer() {
  ...
  function handleAdd() {
    ...
    const sten = wallets[wallet_id.value].type === COLOURED_COIN
      ? colouredcoin_to_sten(amount_input.value)
      : achi_to_sten(amount_input.value);

    const trade = buy_or_sell.value === 1
      ? newBuy(sten, wallet_id.value)
      : newSell(sten, wallet_id.value);
